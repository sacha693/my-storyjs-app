  ...
  outbound: [
    {
      ...
      lineName: '南海本線＋步行',
      lineColor: '#1f4fa3',
      direction: '從 OASIS 依 Google Maps 前往天下茶屋站，搭南海本線往住吉大社站，再步行到住吉大社。',
    ...
    },
    {
      ...
      lineName: '南海本線＋步行',
      lineColor: '#1f4fa3',
      direction: '住吉大社參拜後回南海線，搭往南海難波，再依 Google Maps 步行往日本橋電電街。',
    ...
    },
    {
      ...
      lineColor: '#6b7280',
      direction: '日本橋、Joshin 與千日前道具屋筋屬同一區塊，依 Google Maps 步行串接。',
    ...
    },
    {
      ...
      lineName: 'Google Maps 步行',
      lineColor: '#6b7280',
      direction: '傍晚依 Google Maps 往道頓堀移動，晚餐後不要再追加太多行程。',
  ...
  inbound: [
    {
      ...
      lineColor: '#0078ba',
      direction: '晚餐後依 Google Maps 前往四つ橋線可搭乘站點，搭往住之江公園方向到岸里站，再步行回 OASIS。',
